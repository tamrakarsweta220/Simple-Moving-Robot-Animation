...
public class Robot {
    ...
    public static void main(String[] args) {
        ...
        Square s1 = new Square(400, 200, 100, Color.blue);
        objList.addDrawable(s1);
        
        Rectangle r1 = new Rectangle(400, 400, 140, 200, Color.red);
        objList.addDrawable(r1);
        
        Square s2 = new Square(330, 700, 60, Color.blue);
        objList.addDrawable(s2);
        
        Square s3 = new Square(470, 700, 60, Color.blue);
        objList.addDrawable(s3);
        
        Rectangle r2 = new Rectangle(250, 380, 60, 30, Color.blue);
        objList.addDrawable(r2);
        
        Rectangle r3 = new Rectangle(550, 380, 60, 30, Color.blue);
        objList.addDrawable(r3);
        
        Circle c1 = new Circle(350, 150, 30, Color.white);
        objList.addDrawable(c1);
        
        Circle c2 = new Circle(450, 150, 30, Color.white);
        objList.addDrawable(c2);
        
        Rectangle r4 = new Rectangle(400, 230, 40, 20, Color.white);
        objList.addDrawable(r4);

        Rectangle r5 = new Rectangle(350, 75, 10, 20, Color.blue);
        objList.addDrawable(r5);

        Rectangle r6 = new Rectangle(450, 75, 10, 20, Color.blue);
        objList.addDrawable(r6);
        
        Circle c3 = new Circle(350, 70, 20, Color.blue);
        objList.addDrawable(c3);
        
        Circle c4 = new Circle(450, 70, 20, Color.blue);
